...
static const _SetMode_Request_type_support_symbol_names_t _SetMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, srv, SetMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, srv, SetMode_Request)),
  }
};
...
{
  return &::rm_interfaces::srv::rosidl_typesupport_cpp::SetMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_interfaces, srv, SetMode_Request)() {
  return get_message_type_support_handle<rm_interfaces::srv::SetMode_Request>();
}
...
static const _SetMode_Response_type_support_symbol_names_t _SetMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, srv, SetMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, srv, SetMode_Response)),
  }
};
...
{
  return &::rm_interfaces::srv::rosidl_typesupport_cpp::SetMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_interfaces, srv, SetMode_Response)() {
  return get_message_type_support_handle<rm_interfaces::srv::SetMode_Response>();
}
...
static const _SetMode_type_support_symbol_names_t _SetMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, srv, SetMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, srv, SetMode)),
  }
};
...
{
  return &::rm_interfaces::srv::rosidl_typesupport_cpp::SetMode_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_interfaces, srv, SetMode)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rm_interfaces::srv::SetMode>();
}
