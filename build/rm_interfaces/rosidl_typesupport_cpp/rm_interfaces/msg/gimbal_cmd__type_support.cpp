...
static const _GimbalCmd_type_support_symbol_names_t _GimbalCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, GimbalCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, msg, GimbalCmd)),
  }
};
...
{
  return &::rm_interfaces::msg::rosidl_typesupport_cpp::GimbalCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_interfaces, msg, GimbalCmd)() {
  return get_message_type_support_handle<rm_interfaces::msg::GimbalCmd>();
}
